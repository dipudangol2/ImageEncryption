...
class SecureFileManager:
    ...
    # File cleanup timeout (30 minutes)
    CLEANUP_TIMEOUT = 30 * 60
    ...
    def validate_file(self, file_content: bytes, filename: str, content_type: Optional[str] = None) -> tuple[bool, str]:
        """
    ...
    def save_upload(self, file_content: bytes, filename: str, session_id: Optional[str] = None) -> tuple[Path, str]:
        """
